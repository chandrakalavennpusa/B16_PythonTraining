...
######print of numbers using range##########

for val in range(100, 200, 2):
    print("Even number value : ", val)


 #######print of odd numbers 1000 to 2000#######3 using range

for val in range(1001, 2001, 2):
    print("Odd number value : ", val)
